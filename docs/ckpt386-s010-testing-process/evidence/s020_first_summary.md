...
- github_mcp_commits_fix_repeat | q4nl_ckpt386_s020_t07_graph_fa_c65536_pair49 | pass=True | score=1.0 | rc=1 | elapsed=270s
...
- github_mcp_pr_details_fix | q4nl_ckpt386_s020_t07_graph_fa_c65536_pair49 | pass=True | score=1.0 | rc=124 | elapsed=600s
...
- local_search_kill_excess_fix | q4nl_ckpt386_s020_t07_graph_fa_c65536_pair49 | pass=True | score=1.0 | rc=0 | elapsed=99s
  - checks: build_passes=yes, does_not_use_blanket_pkill=yes, has_targeted_kill_logic=yes, references_process_pid=yes
- local_search_search_timeout_fix | q4nl_ckpt386_s020_t07_graph_fa_c65536_pair49 | pass=True | score=1.0 | rc=1 | elapsed=388s
  - checks: build_passes=yes, handler_passes_timeout=yes, handler_reads_timeout=yes, schema_has_timeout=yes
- local_search_web_search_race_fix | q4nl_ckpt386_s020_t07_graph_fa_c65536_pair49 | pass=True | score=1.0 | rc=0 | elapsed=211s
